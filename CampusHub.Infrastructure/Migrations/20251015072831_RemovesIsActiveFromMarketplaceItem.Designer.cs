...
namespace CampusHub.Infrastructure.Migrations
{
    ...
    [Migration("20251015072831_RemovesIsActiveFromMarketplaceItem")]
    partial class RemovesIsActiveFromMarketplaceItem
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("CampusHub.Domain.Entities.Event", b =>
                {
                    ...
                    b.HasOne("CampusHub.Domain.Entities.College", null)
                        .WithMany("Events")
                        .HasForeignKey("CollegeId1");

                    b.HasOne("CampusHub.Domain.Entities.User", "Organizer")
                        .WithMany()
                        .HasForeignKey("OrganizerId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("CampusHub.Domain.Entities.ProgramEntity", null)
                        .WithMany("Events")
